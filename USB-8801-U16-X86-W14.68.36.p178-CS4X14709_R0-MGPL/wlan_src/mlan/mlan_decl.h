 ...
 *  SAE Sustenance Team to use "CS" instead of "C" in driver tag to differentiate from R&D C-driver code
 *  Ex : #define MLAN_RELEASE_VERSION "CS7XX"
*/
#define MLAN_RELEASE_VERSION		 "CS709"
