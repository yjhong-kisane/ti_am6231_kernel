...
//=================================================================================================================================
	//NOTE::2023-04-26
	// i2c open 시 터치가 안되는 증상 (매우 빈번히 발생)
	// i2c touch enable cmd 전송 후 Touch IC 의 i2c 버퍼를 비워주기 위해 i2c recv 실행
	i2c_master_recv(ar1021->client, ar1021->data, sizeof(ar1021->data));
//=================================================================================================================================
