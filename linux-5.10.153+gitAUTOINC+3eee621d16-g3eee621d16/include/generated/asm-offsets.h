...
#define TSK_STACK_CANARY 1320 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 2944 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_KEYS_USER 3912 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 3992 /* offsetof(struct task_struct, thread.keys_kernel) */
...
#define TRAMP_VALIAS -4322258944 /* TRAMP_VALIAS */
